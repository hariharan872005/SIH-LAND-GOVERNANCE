...
let AuditController = class AuditController {
    ...
    async getLogs(pagination, officerId, landId, action, entityType) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve immutable audit log records with pagination and filters' }),
    (0, permissions_decorator_1.RequirePermissions)(permissions_enum_1.PermissionCode.VIEW_AUDIT_LOGS),
    __param(0, (0, common_1.Query)()),
    __param(1, (0, common_1.Query)('officerId')),
    __param(2, (0, common_1.Query)('landId')),
